  ...
  return {
    init: function(){
      try {
        ...
        now = "23_24"
        nowstring = "View Current Year's Assignment (2023-24)"
        nowprefix = "2023-2024"

        nextyear = "24_25"  //used in the link back to Durham Maps
        nextstring = "View Next Year's Assignment (2024-25)"  //used in the button
        nextprefix = "2024-2025" //used in results table
